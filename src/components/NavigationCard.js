...
const nonActiveElement = 'flex gap-3 py-2 my-2 -mx-4 px-4 rounded-md hover:bg-blue-500 hover:bg-opacity-20 transition-all hover:scale-110 hover:shadow-md shadow-gray-300';
